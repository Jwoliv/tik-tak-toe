...
const GameHeader = ({ playersCount, gameState, setGameState }) => {
    return (
        <div>
            ...
            <GameHeaderProfileBlock currentProgress={gameState.currentProgress} setGameState={setGameState} playersCount={playersCount} />
        </div>
    )
}
